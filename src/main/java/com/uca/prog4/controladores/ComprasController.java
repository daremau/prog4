...
import com.uca.prog4.clases.ComprasFacade;
...
public class ComprasController implements Serializable {
    ...
    @EJB
    private com.uca.prog4.clases.ComprasFacade ejbFacade;
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public DataModel createPageDataModel() {
                    return new ListDataModel(getFacade().findRangeByAttribute(new int[]{getPageFirstItem(), getPageFirstItem() + getPageSize()}, "compra"));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        ...
        if (selectedItemIndex >= 0) {
            current = getFacade().findRangeByAttribute(new int[]{selectedItemIndex, selectedItemIndex + 1}, "compra").get(0);
        }
    }
    ...
    public static class ComprasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Compras) {
                ...
                return getStringKey(o.getCompra());
            } else {
